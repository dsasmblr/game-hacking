...
**.NET Deobfuscator/Unpacker** | [de4dot](https://github.com/0xd4d/de4dot) | *An open source .NET deobfuscator and unpacker written in C#. Most obfuscation from supported platforms can be completely restored (eg. string encryption), but symbol renaming is impossible to restore since the original names aren't (usually) part of the obfuscated assembly.*
